...
import { PopUpConfirm, FormInput, MainHeader, Loading, ButtonGradient } from '../../../../../components/react-native-teso';
...
import { discountActions, orderActions } from '../../../../../actions/index';
        ...
        return (
            <SafeAreaView style={styles.container}>
                            ...
                            <FlatList showsVerticalScrollIndicator={false}
                                ...
                                renderItem={({ item }) =>
                                    <View style={[styles.discountService, { width: '31%', justifyContent: 'center', alignItems: 'center' }]} >
                                        <Text style={{ color: Colors.lightText, fontSize: FontStyle.mdText }} numberOfLines={1} ellipsizeMode={'tail'}>{item.displayName}</Text>
                                    </View>
                ...
                <PopUpConfirm
                    ...
                    modalText={'Bạn chắc chắn muốn chọn khuyến mãi này?'}
                    confirmText={'Chọn'}
                    confirmPress={() => {
                        this._toggleModal()
                        storeService.dispatch(orderActions.updatePromotion({
                            'newPromotion': {
                                'id': this.props.id,
